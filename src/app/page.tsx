   ...
   <div className="bg-bodyColor max-h-screen text-white/80 ">
    ...
    <Container className="py-12 grid  grid-cols-1 md:grid-cols-2 gap-10">
         <div className="flex flex-col items-center md:items-start gap-5 md:gap-7 text-center md:text-start">
            <div>
              <h3 className="font-semibold tracking-wide mb-1">Web Developer</h3>
              <h2 className="text-3xl md:text-5xl mb-2 text-white">Hello I&apos;m</h2>
              <h2 className="text-lightSky text-5xl md:text-7xl tracking-normal">Shaukat Khan</h2>
            </div>
               <div className="w-full h-[170px] md:[140px] relative">
